...
# type: ignore
# config = None  # qutebrowser injects this
# c = None
# Documentation:
...
# Type: QssColor
c.colors.hints.fg = '#A4BFCBFF'

# Font color for the matched part of hints.
# Type: QtColor
c.colors.hints.match.fg = '#46555DFF'
...
# Type: Font
c.fonts.hints = '15pt Agave Nerd Font'
...
# Type: String
c.hints.border = '1px solid #46555D'

# Characters used for hint strings.
# Type: UniqueCharString
c.hints.chars = '1234zxcvrqweasd'
...
c.statusbar.widgets = ['keypress', 'url', 'mode', 'scroll', 'history', 'tabs', 'progress']
...
keybindings.add_bindings(config)


config.unbind("q")
for key, url in tables.quick_access_table.items():
	config.bind(f"qq{key}", f"open -t {url}")

for key, proxy in tables.proxy_table.items():
	config.bind(f"cp{key}", f"set content.proxy {proxy}")

for site in tables.force_dark_sites:
